...
export default function SetCard({ setCount = 1, onDelete, isDeletable = true }) {
  ...
  return (
    <div className="w-full h-auto p-2 flex items-center gap-2 bg-brand-grey3 rounded-full">
      ...
      <div className="flex items-center bg-brand-grey4 rounded-full text-xs px-2">
        ...
        <div className="flex items-center gap-1 px-1">
          <input
            ...
            className="no-spinner w-9 bg-transparent text-center focus:outline-none"
            placeholder="0"
          />
          <p>kg</p>
        </div>
        ...
        <div className="flex items-center gap-1 px-1">
          <input
            ...
            className="no-spinner w-8 bg-transparent text-center focus:outline-none"
            placeholder="0"
          />
          <p>Reps</p>
        </div>
